...
// theCircle = new Ellipse2D.Double(ball.pos.x - ball.dim.x, ball.pos.y -
// ball.dim.y, 2.0 * ball.dim.x,
// 2.0 * ball.dim.y);
// g2d.setColor(ball.color);
// g2d.fill(theCircle);
// g2d.draw(theCircle);
// // g.setColor(Color.WHITE);
// // g.fillOval(ball.pos.x, ball.pos.y, ball.dim.x, ball.dim.y); // Oval
// Drawing
// // DEPRECATED
// }
// }
...
// leaderboardPanel.setLayout(new BoxLayout(leaderboardPanel,
// BoxLayout.Y_AXIS));
